"""Script that provides command line interface for analyzing bikeshare data,
   getting statistics like most frequent times of travel, most popular stations,
   trip duration, user stats, also gives the option to see raw data."""
import time
import calendar
import pandas as pd
import inquirer
...
def get_filters():
    ...
    while True:
        ...
        question = [inquirer.List('city',
                                 'Please select city on which you want to review data: ',
                                 choices = options)]
